...
const props = defineProps(['invoices', 'isProcessing']);
                ...
                >
                    ...
                    <div class="flex items-center gap-3 w-full md:w-auto">
                        <button 
                            ...
                            class="flex-1 md:flex-none h-12 px-6 rounded-2xl bg-green-50 text-green-700 font-black text-sm flex items-center justify-center gap-2 hover:bg-green-700 hover:text-white transition-all shadow-sm active:scale-95 disabled:opacity-50"
                        >
                            <Eye class="w-4 h-4" />
                            ดูบิล
                        </button>
                        <button 
                            ...
                            :disabled="props.isProcessing"
                            class="w-12 h-12 rounded-2xl bg-red-50 text-red-300 flex items-center justify-center hover:bg-red-500 hover:text-white transition-all shadow-sm active:scale-95 disabled:opacity-50"
                        >
                            <Loader2 v-if="props.isProcessing" class="w-5 h-5 animate-spin" />
